...
{
    public sealed class ClsBairroBO : IGeneric<ClsBairro>
    {
        private static ClsBairro b = null;
        ...
        public ClsBairroBO(ClsBairro bairroClass)
        {
            b = bairroClass ?? new ClsBairro();
        }
        ...
        public void Inserir()
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(BLL.Properties.Settings.Default.connStringUserAut))
                {
                    ...
                    com.Parameters.AddWithValue("@bairro", b.bairro);
                    com.Parameters.AddWithValue("@regiao", b.regiao);
                    com.Parameters.AddWithValue("@cidadeIdcidade", b.cidadeIdcidade.idcidade);
        ...
        public void Alterar()
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(BLL.Properties.Settings.Default.connStringUserAut))
                {
                    ...
                    com.Parameters.AddWithValue("@regiao", b.regiao);
                    com.Parameters.AddWithValue("@cidadeIdcidade", b.cidadeIdcidade.idcidade);
                    com.Parameters.AddWithValue("@id", b.idbairro);
        ...
        public void ValidarClasse(CRUD crud)
        {
            if (crud == CRUD.insert)
            {
                if (string.IsNullOrEmpty(b.bairro))
                {
                    throw new ArgumentNullException("Por favor informe o bairro");
                }
                else if (string.IsNullOrEmpty(b.regiao))
                {
                    throw new ArgumentNullException("Por favor informe a região");
                }
                else if (b.cidadeIdcidade.idcidade.ToString() == "00000000-0000-0000-0000-000000000000")
                {
            ...
            {
                if (b.idbairro.ToString() == "00000000-0000-0000-0000-000000000000")
                {
        ...
        public ClsBairro BuscaPeloId(Guid rowGuidCol)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(BLL.Properties.Settings.Default.connStringUserAut))
                {
                    ...
                    SqlDataReader read = com.ExecuteReader();
                    read.Read();
                    b.idbairro = Guid.Parse(read["idbairro"].ToString());
                    b.bairro = read["bairro"].ToString();
                    b.regiao = read["regiao"].ToString();
                    b.cidadeIdcidade.idcidade = Guid.Parse(read["idcidade"].ToString());
                    b.cidadeIdcidade.cidade = read["cidade"].ToString();
                    b.cidadeIdcidade.DDD = read["DDD"].ToString();
                    b.cidadeIdcidade.capital = (bool)read["capital"];
                    b.cidadeIdcidade.estadoIdestado.idestado = Guid.Parse(read["idestado"].ToString());
                    b.cidadeIdcidade.estadoIdestado.estado = read["estado"].ToString();
                    b.cidadeIdcidade.estadoIdestado.uf = read["uf"].ToString();
                    b.cidadeIdcidade.estadoIdestado.capital = (bool)read["capitalEstado"];
                    b.cidadeIdcidade.estadoIdestado.paisIdpais.idpais = Guid.Parse(read["idpais"].ToString());
                    b.cidadeIdcidade.estadoIdestado.paisIdpais.pais = read["pais"].ToString();
                    b.cidadeIdcidade.estadoIdestado.paisIdpais.idioma = read["idioma"].ToString();
                    b.cidadeIdcidade.estadoIdestado.paisIdpais.DDI = read["DDI"].ToString();
                    b.cidadeIdcidade.estadoIdestado.paisIdpais.sigla = read["sigla"].ToString();
                    b.cidadeIdcidade.estadoIdestado.paisIdpais.fusoHorario = read["fuso_horario"].ToString();
                    b.cidadeIdcidade.estadoIdestado.paisIdpais.continenteIdcontinete.continente = read["continente"].ToString();
                    b.cidadeIdcidade.estadoIdestado.paisIdpais.continenteIdcontinete.tipoContinenteIdtipoContinente.tipoContinente = read["tipo_continente"].ToString();
                    con.Close();
                }
            }
            catch (Exception e)
